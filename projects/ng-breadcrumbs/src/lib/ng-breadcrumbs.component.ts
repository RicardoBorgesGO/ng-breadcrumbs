...
export class NgBreadcrumbsComponent implements OnInit {
  ...
  public constructor(private breadcrumbService: NgBreadcrumbsService, private activatedRoute: ActivatedRoute, private router: Router) {
